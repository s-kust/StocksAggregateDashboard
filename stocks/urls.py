...
# path('sector/<int:sector_id>/', views.sectordetail, name='sectordetail'),
...
path('industry/<slug:slug>/leverage/', views.industrydetailleverage, name='industrydetailleverage'), # leverage
path('industry/<slug:slug>/forward-pe/', views.industrydetailpe, name='industrydetailpe'),
path('industry/<slug:slug>/margin/', views.industrydetailmargin, name='industrydetailmargin'),
