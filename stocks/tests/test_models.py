...
class ModelsTestCase(TestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.industry1 = Industries.objects.create(
            sector=cls.sector2, industry="Industry - 1"
        )
        cls.industry2 = Industries.objects.create(
            sector=cls.sector2, industry="Industry - 2"
        )
        cls.industry3 = Industries.objects.create(
            sector=cls.sector2, industry="Industry - 3"
        )
        cls.industry4 = Industries.objects.create(
            sector=cls.sector1, industry="Industry - 4"
        )
        cls.ticker1 = Tickers.objects.create(
            ticker="ABC", shortname="ABC inc.", industry=cls.industry1
        )
        cls.ticker2 = Tickers.objects.create(
            ticker="DEF", shortname="DEF inc.", industry=cls.industry1
        )
        cls.ticker3 = Tickers.objects.create(
            ticker="GHI", shortname="GHI inc.", industry=cls.industry3
        )
        cls.ticker4 = Tickers.objects.create(
            ticker="JKL", shortname="JKL inc.", industry=cls.industry4
        )
        cls.ticker5 = Tickers.objects.create(
            ticker="MNO", shortname="MNO corp.", industry=cls.industry4
        )
