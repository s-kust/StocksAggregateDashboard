...
class Sectors(models.Model):
    ...
    avg_assets_turnover_sector = models.DecimalField(db_column='avgAssetsTurnoverSector', max_digits=51, decimal_places=10, blank=True, null=True)
...
class Industries(models.Model):
    ...
    avg_assets_turnover = models.DecimalField(db_column='avgAssetsTurnover', max_digits=51, decimal_places=10, blank=True, null=True)  # Field name made lowercase.
...
class Tickers(models.Model):
    ...
    margin = models.DecimalField(db_column='Margin', max_digits=29, decimal_places=10, default=0)  # Field name made lowercase.
    leverage = models.DecimalField(db_column='Leverage', max_digits=29, decimal_places=10, default=0)  # Field name made lowercase.
    liquidity = models.DecimalField(db_column='Liquidity', max_digits=29, decimal_places=10, blank=True, null=True)  # Field name made lowercase.
    assetsturnover = models.DecimalField(db_column='AssetsTurnover', max_digits=47, decimal_places=6, blank=True, null=True)  # Field name made lowercase.
...
class Bosscompensations(models.Model):
    ...
    paymentsum = models.DecimalField(db_column='PaymentSum', max_digits=10, decimal_places=0, blank=True, null=True)  # Field name made lowercase.
    marketcap = models.DecimalField(db_column='MarketCap', max_digits=14, decimal_places=0, blank=True, null=True)  # Field name made lowercase.
...
class Rawdataquarterly(models.Model):
    ...
    cfoperations = models.DecimalField(db_column='cfOperations', max_digits=15, decimal_places=2)  # Field name made lowercase.
    dividendspaid = models.DecimalField(db_column='DividendsPaid', max_digits=15, decimal_places=2)  # Field name made lowercase.
    stockissuance = models.DecimalField(db_column='StockIssuance', max_digits=15, decimal_places=2)  # Field name made lowercase.
    totalassets = models.DecimalField(db_column='TotalAssets', max_digits=15, decimal_places=2)  # Field name made lowercase.
    totallongtermdebt = models.DecimalField(db_column='TotalLongTermDebt', max_digits=15, decimal_places=2)  # Field name made lowercase.
    totalcurrentassets = models.DecimalField(db_column='TotalCurrentAssets', max_digits=15, decimal_places=2)  # Field name made lowercase.
    totalcurrentliabilities = models.DecimalField(db_column='TotalCurrentLiabilities', max_digits=15, decimal_places=2)  # Field name made lowercase.
    totalrevenue = models.DecimalField(db_column='TotalRevenue', max_digits=15, decimal_places=2)  # Field name made lowercase.
    netincomecontinuingops = models.DecimalField(db_column='NetIncomeContinuingOps', max_digits=15, decimal_places=2)  # Field name made lowercase.
    earningssurprise = models.FloatField(db_column='EarningsSurprise', blank=True, null=True)  # Field name made lowercase.
...
class Resultsyearly(models.Model):
    ...
    netincomecontinuingops = models.DecimalField(db_column='NetIncomeContinuingOps', max_digits=15, decimal_places=2)  # Field name made lowercase.
    publicationdate = models.DateField(db_column='PublicationDate', blank=True, null=True)  # Field name made lowercase.
    margin = models.DecimalField(db_column='Margin', max_digits=15, decimal_places=2, blank=True, null=True)  # Field name made lowercase.
    leverage = models.DecimalField(db_column='Leverage', max_digits=15, decimal_places=2, blank=True, null=True)  # Field name made lowercase.
    liquidity = models.DecimalField(db_column='Liquidity', max_digits=15, decimal_places=2, blank=True, null=True)  # Field name made lowercase.
    cfpositive = models.IntegerField(db_column='cfPositive', blank=True, null=True)  # Field name made lowercase.
    nostockissuance = models.IntegerField(db_column='noStockIssuance', blank=True, null=True)  # Field name made lowercase.
    cfaboveincome = models.IntegerField(db_column='cfAboveIncome', blank=True, null=True)  # Field name made lowercase.
