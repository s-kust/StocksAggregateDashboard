...
from .serializers import SectorsSerializer, TickersSerializer, IndustriesSerializer, TickerCombinedSerializer
...
class TickerDetail(APIView):
    def get(self, request, pk):
        ...
        ticker_full_data = TickerCombined(ticker=ticker_info, yearly_results=yearly_results_data)
